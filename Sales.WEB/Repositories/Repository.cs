...
namespace Sales.WEB.Repositories
{
    public class Repository : IRepository
    {
        ...
        {
            var mesageJSON = JsonSerializer.Serialize(model); //agarrar un objeto y volverlo string
        ...
        private async Task<T> UnserializeAnswer<T>(HttpResponseMessage httpResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return JsonSerializer.Deserialize<T>(respuestaString, jsonSerializerOptions)!;//agarrar un string de json y volverlo nuevamente objeto
        }
